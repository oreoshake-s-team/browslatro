...
| Production model | `claude-opus-4-8` (overridable via `ADVISOR_MODEL`). | Hand: [`advisor-policy-v8.onnx`](../../public/models/advisor-policy-v8.onnx). Shop: [`advisor-shop-policy-v4.onnx`](../../public/models/advisor-shop-policy-v4.onnx). |
...
- **LLM teacher for the shop policy (`#1338`).** Same idea for shop decisions, with a Claude Sonnet 4.6 teacher. The shipped `advisor-shop-policy-v4` is rollout-labeled, not teacher-distilled.
