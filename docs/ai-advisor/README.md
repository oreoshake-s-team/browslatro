...
| Production model | `claude-opus-4-8` (overridable via `ADVISOR_MODEL`). | Hand: [`advisor-policy-v9.onnx`](../../public/models/advisor-policy-v9.onnx). Shop: [`advisor-shop-policy-v13.onnx`](../../public/models/advisor-shop-policy-v13.onnx) (use-aware, voucher-aware v2 encoding). |
...
- **LLM teacher for the shop policy (`#1338`).** Same idea for shop decisions, with a Claude Sonnet 4.6 teacher. The shipped `advisor-shop-policy-v13` is trained by on-policy self-play with a PPO trust region, warm-started from `advisor-shop-policy-v12` (grafted to the wider voucher-aware encoding) and iterated on the voucher-aware, sell-capable headless sim; neither is teacher-distilled.
