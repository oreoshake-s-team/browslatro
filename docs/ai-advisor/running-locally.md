...
python3 ml/train.py shop.jsonl --shop --out public/models/advisor-shop-policy-v6.onnx
```
...
python3 ml/evaluate_real_play.py --shop public/models/advisor-shop-policy-v6.onnx
```
