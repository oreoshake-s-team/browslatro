...
Shop and pack decisions are a separate model with a separate [28-feature encoding](./engine-plumbing.md#shop-encoding-shopencodingts), separate labels, and a separate file (`advisor-shop-policy-v4.onnx`).
