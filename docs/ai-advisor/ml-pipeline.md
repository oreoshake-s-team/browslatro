...
Shop and pack decisions are a separate model with a separate [build-aware, use-aware 79-feature (v2) encoding](./engine-plumbing.md#shop-encoding-shopencodingts), separate labels, and a separate file (`advisor-shop-policy-v12.onnx`).
