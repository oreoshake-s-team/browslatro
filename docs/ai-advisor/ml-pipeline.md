...
Shop and pack decisions are a separate model with a separate [46-feature encoding](./engine-plumbing.md#shop-encoding-shopencodingts), separate labels, and a separate file (`advisor-shop-policy-v6.onnx`).
