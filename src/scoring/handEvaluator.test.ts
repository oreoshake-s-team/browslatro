...
describe("handContains", () => {
  test.each<{ outer: HandLabel; inner: HandLabel; expected: boolean }>([
    ...
    { outer: "Full House", inner: "Two Pair", expected: true },
    { outer: "Flush House", inner: "Two Pair", expected: true },
    { outer: "Four of a Kind", inner: "Two Pair", expected: false },
    { outer: "Five of a Kind", inner: "Two Pair", expected: false },
    { outer: "Flush Five", inner: "Two Pair", expected: false },
