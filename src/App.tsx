...
function App() {
  ...
  // Post-round shop: when non-null, the shop overlay is open between the
  // round-won payout and the start of the next round. Null = shop closed.
  ...
  function handleWin() {
    ...
    // Open the post-round shop. The next round is deferred until the player
    // either buys / skips, then clicks Next Round (or presses Escape).
    setShopOffers(
