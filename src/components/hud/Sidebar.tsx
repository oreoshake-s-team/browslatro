...
export default function Sidebar({
  ...
  return (
    ...
    <aside
      ...
      data-testid="sidebar"
    >
      <div className="flex flex-col gap-4 portrait-narrow:min-w-40 portrait-narrow:flex-1 landscape-narrow:gap-2">
        <Round
          blind={blind}
      ...
      <div className="flex flex-col gap-3 portrait-narrow:min-w-40 portrait-narrow:flex-1">
        ...
        <div className="flex flex-col gap-2" data-testid="progress">
          <RoundProgress
