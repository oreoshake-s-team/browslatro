  ...
  return (
    <>
      {groups.map((group) => {
        ...
        const MoneyHeading = group.base ? "h4" : "h3";
        return (
          <section
            key={key}
          ...
          >
            ...
            {scoring.length > 0 ? (
              <ol
                className="list-decimal pl-6 marker:text-muted"
                data-testid="trace-scoring-list"
              >
                {scoring.map((event, index) => (
                  <li key={index} className="text-muted" data-trace-item="">
            ...
            {money.length > 0 ? (
              <div className="mt-1">
                <MoneyHeading className="font-bold text-money">
                  Money won
                </MoneyHeading>
                <ol
                  className="list-decimal pl-6 marker:text-muted"
                  data-testid="trace-money-list"
                >
